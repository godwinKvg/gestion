<div class="container">
    ...
    <div class=" d-flex flex-wrap justify-content-start">
        <div class="alert alert-primary position-absolute fade hide " style="right:20px;top:15%" id="alert"></div>
        <?php
        ...
        <div class="text-center me-2 my-2 d-flex flex-column justify-content-between bg-dark p-2 text-white"
            ...
            <div>
                <img src="<?=  $g->image ? '/upload/' . $g->image : '/src/public/images/groupe.ico' ?>"
                    alt="Groupe icon" class="rounded-circle" style="width:100px;  height: auto;">
            </div>
            <div class="d-flex flex-column justify-content-center align-items-between">
                ...
                <a href="#" class="btn btn-sm btn-warning mb-2">Ajouter Contact </a>
                <a href="/groupeContacts?id=<?= $g->id ?>" class="btn btn-sm btn-success">Contacts</a>
