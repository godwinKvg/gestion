...
?>
    ...
    <script>
        ...
        updateFrom.addEventListener('submit', (e) => {
            updateFrom.querySelector("button[type=submit]").sty
            ...
            fetch(CONTACT_API_URL, params)
                ...
                .then(data => {
                    ...
                    if (data.status === 200) {
                        ...
                        document.querySelector("a[data-contact]").setAttribute('data-contact', JSON.stringify(contact))
